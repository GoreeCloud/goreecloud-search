...
Draft or unmerged pull requests are not implementation authority. Draft PR #29 remains historical provenance; equivalent query-control hardening was replayed and merged as PR #34 onto current `main`.

## Current verified Development baseline

PR #28 established the earlier runtime-readiness baseline at `1bf27785cf5502e32155d3d3d31bc5cbd052d3d6` (CI #78 and Platform Contract #20 passed at that exact revision). Current accepted `main` is `66ff984b8dd79624a739ab6117c42a572dc44475`, merged via PR #34. PR #33 first corrected the repository identity to `GoreeCloud/search`; PR #34 then added C0/DEL request rejection prior to authentication or provider execution.
