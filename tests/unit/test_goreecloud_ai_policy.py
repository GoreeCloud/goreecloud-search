...
class GoreeCloudAIPolicyContractTest(unittest.TestCase):
    ...
    def test_contributing_uses_goreecloud_ai_policy(self):
        ...
        self.assertIn("AI-assisted and agent-authored contributions are permitted", self.contributing)
        self.assertIn("does not impose a human-written-majority requirement", self.contributing)
        self.assertIn("upstream SearXNG project controls its own contribution and AI policies", self.contributing)
